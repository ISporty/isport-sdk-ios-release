...
#ifndef ISPORTSDK_SWIFT_H
#define ISPORTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ISPORTSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ISPORTSDK9ISPORTSDK")
@interface ISPORTSDK : NSObject
...
- (nonnull instancetype)initWithMatchId:(NSString * _Nullable)matchId token:(NSString * _Nullable)token type:(enum ViewType)type env:(enum Environment)env paramDeepLink:(NSString * _Nonnull)paramDeepLink debug:(BOOL)debug OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9ISPORTSDK15ISportWebAction")
@interface ISportWebAction : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
